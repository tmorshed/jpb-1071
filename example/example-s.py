...
#%%
dur_param = [135]
for kel in dur_param:
    seed(10)
    numSTN = 2 #Original is 1
    numGPe = 2 #Original is 1
    ...
    iclamp.dur   = kel # 0.1 # Original is 0.1 # ms
    iclamp.amp   =  15# 30 #Original is 15  # nA
    iclamp.delay = 50  # Original is 50 ms
    ...
    for stn in STNs:
        ...
        syn.e    = -80 # Inhibitory
        syn.tau  = 30 #10 #Original is 30 # Decay
        STN_syns.append(syn)
    ...
    for gpe in GPes:
        ...
        syn.e    = 0# Original value is 0 # Excitatory
        syn.tau  = 10 #5#Original is 10 # Decay
        GPe_syns.append(syn)
    ...
    for stn in STNs:
        ...
        con.weight[0] = 10 # Original is 10
        netcons.append(con)
