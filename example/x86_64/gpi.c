...
#define nrn_init _nrn_init__GPi
#define _nrn_initial _nrn_initial__GPi
#define nrn_cur _nrn_cur__GPi
#define _nrn_current _nrn_current__GPi
#define nrn_jacob _nrn_jacob__GPi
#define nrn_state _nrn_state__GPi
#define _net_receive _net_receive__GPi 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 GPi /home/taha/git/jpb-1071/example/Mechanisms/gpi.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "passive membrane properties for GPi";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/taha/git/jpb-1071/example/Mechanisms/gpi.mod";
static const char* nmodl_file_text = 
