...
#define nrn_init _nrn_init__STN_Na
#define _nrn_initial _nrn_initial__STN_Na
#define nrn_cur _nrn_cur__STN_Na
#define _nrn_current _nrn_current__STN_Na
#define nrn_jacob _nrn_jacob__STN_Na
#define nrn_state _nrn_state__STN_Na
#define _net_receive _net_receive__STN_Na 
#define _f_settables _f_settables__STN_Na 
#define settables settables__STN_Na 
#define states states__STN_Na 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_STN_Na", _hoc_setdata,
 "settables_STN_Na", _hoc_settables,
 "vtrap_STN_Na", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_STN_Na
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define Q10 Q10_STN_Na
 double Q10 = 1.98011;
#define activate_Q10 activate_Q10_STN_Na
 double activate_Q10 = 1;
#define gmax_k gmax_k_STN_Na
 double gmax_k = 0;
#define gmaxQ10 gmaxQ10_STN_Na
 double gmaxQ10 = 1.98011;
#define rate_k rate_k_STN_Na
 double rate_k = 0;
#define rest rest_STN_Na
 double rest = -60;
#define tempb tempb_STN_Na
 double tempb = 23;
#define temp2 temp2_STN_Na
 double temp2 = 29;
#define temp1 temp1_STN_Na
 double temp1 = 19;
#define usetable usetable_STN_Na
 double usetable = 1;
 ...
 "rest_STN_Na", &rest_STN_Na,
 "activate_Q10_STN_Na", &activate_Q10_STN_Na,
 "Q10_STN_Na", &Q10_STN_Na,
 "gmaxQ10_STN_Na", &gmaxQ10_STN_Na,
 "temp1_STN_Na", &temp1_STN_Na,
 "temp2_STN_Na", &temp2_STN_Na,
 "tempb_STN_Na", &tempb_STN_Na,
 "rate_k_STN_Na", &rate_k_STN_Na,
 "gmax_k_STN_Na", &gmax_k_STN_Na,
 "usetable_STN_Na", &usetable_STN_Na,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 STN_Na /home/taha/git/jpb-1071/example/Mechanisms/STN_Na.mod\n");
 ...
 v=_v;
{
  ...
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 67 in file STN_Na.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/taha/git/jpb-1071/example/Mechanisms/STN_Na.mod";
static const char* nmodl_file_text = 
