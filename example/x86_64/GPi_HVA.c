...
#define nrn_init _nrn_init__GPi_HVA
#define _nrn_initial _nrn_initial__GPi_HVA
#define nrn_cur _nrn_cur__GPi_HVA
#define _nrn_current _nrn_current__GPi_HVA
#define nrn_jacob _nrn_jacob__GPi_HVA
#define nrn_state _nrn_state__GPi_HVA
#define _net_receive _net_receive__GPi_HVA 
#define _f_settables _f_settables__GPi_HVA 
#define setCadepLinact setCadepLinact__GPi_HVA 
#define settables settables__GPi_HVA 
#define states states__GPi_HVA 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_GPi_HVA", _hoc_setdata,
 "ghkg_GPi_HVA", _hoc_ghkg,
 "setCadepLinact_GPi_HVA", _hoc_setCadepLinact,
 "settables_GPi_HVA", _hoc_settables,
 0, 0
};
#define ghkg ghkg_GPi_HVA
 extern double ghkg( double , double , double , double );
 /* declare global and static user variables */
#define gmax_k gmax_k_GPi_HVA
 double gmax_k = 0;
#define inactLmax inactLmax_GPi_HVA
 double inactLmax = 0.529;
#define inactLtau inactLtau_GPi_HVA
 double inactLtau = 1220;
#define rate_k rate_k_GPi_HVA
 double rate_k = 0;
#define usetable usetable_GPi_HVA
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_GPi_HVA", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "inactLtau_GPi_HVA", "ms",
 "gcaL_GPi_HVA", "mho/cm2",
 "gcaN_GPi_HVA", "mho/cm2",
 "iNCa_GPi_HVA", "mA/cm2",
 "iLCa_GPi_HVA", "mA/cm2",
 0,0
};
 ...
 "inactLtau_GPi_HVA", &inactLtau_GPi_HVA,
 "inactLmax_GPi_HVA", &inactLmax_GPi_HVA,
 "rate_k_GPi_HVA", &rate_k_GPi_HVA,
 "gmax_k_GPi_HVA", &gmax_k_GPi_HVA,
 "usetable_GPi_HVA", &usetable_GPi_HVA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 GPi_HVA /home/taha/git/jpb-1071/example/Mechanisms/GPi_HVA.mod\n");
...
static int _reset;
static char *modelname = "calcium HVA channels for GPi neuron model";
...
double ghkg (  double _lv , double _lci , double _lco , double _lz ) {
   double _lghkg;
 double _lnu , _lff , _lenu , _lfnu ;
 _lff = ( 1.0e3 / _lz ) * R * ( celsius + 273.15 ) / FARADAY ;
   _lnu = _lv / _lff ;
   _lenu = exp ( _lnu ) ;
   if ( fabs ( _lnu ) < 1e-4 ) {
     _lfnu = 1.0 - _lnu / 2.0 ;
   ...
   _lghkg = - _lff * ( 1.0 - ( _lci / _lco ) * _lenu ) * _lfnu ;
 ...
 v=_v;
{
  ...
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 66 in file GPi_HVA.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/taha/git/jpb-1071/example/Mechanisms/GPi_HVA.mod";
static const char* nmodl_file_text = 
