...
#define nrn_init _nrn_init__GPi_cacum
#define _nrn_initial _nrn_initial__GPi_cacum
#define nrn_cur _nrn_cur__GPi_cacum
#define _nrn_current _nrn_current__GPi_cacum
#define nrn_jacob _nrn_jacob__GPi_cacum
#define nrn_state _nrn_state__GPi_cacum
#define _net_receive _net_receive__GPi_cacum 
#define integrate integrate__GPi_cacum 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_GPi_cacum", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define cai0_ca_ion cai0_ca_ion_GPi_cacum
 double cai0_ca_ion = 0.0001;
#define cao0 cao0_GPi_cacum
 double cao0 = 2.4;
#define cai0 cai0_GPi_cacum
 double cai0 = 5e-05;
#define depth depth_GPi_cacum
 double depth = 200;
#define tau tau_GPi_cacum
 double tau = 10;
 ...
 "cai0_GPi_cacum", "mM",
 "cao0_GPi_cacum", "mM",
 "cai0_ca_ion_GPi_cacum", "mM",
 0,0
};
 static double delta_t = 0.01;
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "depth_GPi_cacum", &depth_GPi_cacum,
 "tau_GPi_cacum", &tau_GPi_cacum,
 "cai0_GPi_cacum", &cai0_GPi_cacum,
 "cao0_GPi_cacum", &cao0_GPi_cacum,
 "cai0_ca_ion_GPi_cacum", &cai0_ca_ion_GPi_cacum,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 GPi_cacum /home/taha/git/jpb-1071/example/Mechanisms/GPi_cacum.mod\n");
...
static int _reset;
static char *modelname = "calcium accumulation for GPi neuron model";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/taha/git/jpb-1071/example/Mechanisms/GPi_cacum.mod";
static const char* nmodl_file_text = 
